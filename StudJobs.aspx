<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="StudJobs.aspx.cs" Inherits="student.StudJobs" %>
            ...
            <div class="card">
                <div class="card-body">
                   ...
                   <asp:Panel ID="Paneltchjobdisplay" runat="server">
                       <asp:DataList ID="DataListstudaplly" runat="server" width= "100%">
                           <ItemTemplate>
                               <div class="card" id="postcard">
                                   ...
                                   <br />
                                       <asp:Button ID="Buttonapply" runat="server" Text="Apply" Width="50%"  class="btn btn-primary" CommandArgument=<%# Eval("Job_ID")%>  OnClick="Buttonapply_Click" />
                                   </div>
                               </div>
                               <br />
                           </ItemTemplate>
